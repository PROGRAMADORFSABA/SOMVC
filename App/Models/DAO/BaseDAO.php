...
abstract class BaseDAO
{
    ...
    {       
        ...
        $resultado_tabela = mysqli_query($this->conexao, $result_tabela);
        ...
        try		{
          ...
          //      print_r( $tabela)."<br>";
                ...
                $resultado_colunas = mysqli_query($this->conexao, $result_colunas);
                ...
                $resultado_cd_col = mysqli_query($this->conexao,  $result_cr_col);
