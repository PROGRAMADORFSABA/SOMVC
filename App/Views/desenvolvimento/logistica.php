...
<div class="container">
    ...
    <?php } ?>
    <!--begin::Form-->
    <form class="kt-form kt-form--label-right" action="#" method="post" id="form_cadastro"
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    <div class="col-lg-8">
                        ...
                        <input type="text" class="form-control" placeholder="Informe a transportadora" id="transportadora"
                            name="transportadora" value="<?php $Sessao::retornaValorFormulario('transportadora');?>"
                            required>
                        <span class="form-text text-muted">Informe a Transportadora</span>
                    </div>
                    <div class="col-lg-4">
                        <label for="cnpj">CNPJ:</label>
                        <input type="text" class="form-control" placeholder="Informe a cnpj" id="cnpj"
                            name="cnpj" value="<?php $Sessao::retornaValorFormulario('cnpj');?>"
                            required>
                        <span class="form-text text-muted">Informe a Transportadora</span>
                    </div>
                </div>
                <div class="form-group row">
                        ...
                        <div class="col-lg-5">
                            ...
                            <select class="form-control" id="representante" name="representante" required>
                                ...
                                <option value="">representante 1</option>
                                <option value="">representante 2</option>
                                <option value="">representante 3</option>
                ...
                <div class="form-group row">
                    <div class="col-lg-2">
                        ...
                        <input type="text" class="form-control" placeholder="Informe o numero do pedido"
                            ...
                            value="<?php $Sessao::retornaValorFormulario('numeroPedido');?>" required>
                    ...
                    <div class="col-lg-3">
                    <button type="submit" class="btn btn-success btn-elevate btn-pill btn-elevate-air">Adicionar</button>
                    </div>
                </div>
            </div>
            <div class="kt-portlet__body">
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <a href="#"
                                class="btn btn-info btn-elevate btn-pill btn-elevate-air">Voltar</a>
                        </div>
                    </div>
                </div>
            </div>
