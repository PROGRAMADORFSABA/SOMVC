    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <form action="http://<?php echo APP_HOST; ?>/usuario/atualizar" method="post" id="form_cadastro">
                <input type="text" class="form-control" name="id" id="id" value="<?php echo $viewVar['usuario']->getId(); ?>">
                <input type="text" class="form-control" name="fk_instituicao" id="fk_instituicao" value="<?php echo $_SESSION['idInstituicao']; ?>" required>
                ...
                <div class="form-group"><label for="id_dep">Departamento</label>
