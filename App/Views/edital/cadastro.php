            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        ...
                        <input type="text" class="form-control" placeholder="Digite o valor da Proposta" id="valor"
                            name="valor" value="<?php echo $Sessao::retornaValorFormulario('valor'); ?>" required>
                    ...
                    <div class="col-lg-2">
                        ...
                        <input type="date" class="form-control" placeholder="Digite a Data de Resultado"
                            id="dataResultado" name="dataResultado"
                            value="<?php echo $Sessao::retornaValorFormulario('dataResultado'); ?>">
