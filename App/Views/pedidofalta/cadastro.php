<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet">
        ...
        <form class="kt-form kt-form--label-right" method="POST"
            action="http://<?php echo APP_HOST; ?>/pedidofalta/salvar">
            <div class="kt-portlet__body">
                <section class="panel panel-default">
                    <div class="form-group row form-group-marginless kt-margin-t-20">
                        ...
                        <div class="col-lg-3">
                            <input type="text" class="form-control" placeholder="Proposta" required
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="kt-input-icon">
                                <input type="text" id="autocomplete-produto" class="form-control"
                                    placeholder="Auto - complete Produto">
                                <span class="kt-input-icon__icon kt-input-icon__icon--right"><span><i
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input type="hidden" name="produtos[]"
                                                value=<?php echo $produto->getProCodigo(); ?>>
                                        </td>
                                        <td><button class="btn btn-danger btn-sm" type="button"
                                                onClick="app.removeProduto(this,<?php echo $produto->getProCodigo(); ?>)">remover</button>
                                        </td>
                                    </tr>
                                    <?php
                                }
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <a href="http://<?php echo APP_HOST; ?>/pedidofalta/index"
