					...
					<div class="kt-footer kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop">
						<div class="kt-footer__copyright">
							2019&nbsp;&copy;&nbsp;<a href="http://devaction.com.br/" target="_blank" class="kt-link">devAction</a>
						</div>

						<div id="timefooter" name="timefooter"></div>

						<div class="kt-footer__menu">
							<a href="http://devaction.com.br" target="_blank" class="kt-footer__menu-link kt-link">Sobre</a>
							<a href="http://devaction.com.br" target="_blank" class="kt-footer__menu-link kt-link">Equipe</a>
							<a href="http://devaction.com.br" target="_blank" class="kt-footer__menu-link kt-link">Contato</a>
						</div>
					</div>
			...
			<div class="kt-quick-panel__nav">
				<ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-brand  kt-notification-item-padding-x" role="tablist">
					<li class="nav-item active">
						<a class="nav-link active" data-toggle="tab" href="#kt_quick_panel_tab_notifications" role="tab">Notificações</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#kt_quick_panel_tab_logs" role="tab">Registros de Auditoria</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#kt_quick_panel_tab_settings" role="tab">Definições</a>
					</li>
				</ul>
			</div>
					...
					<div class="tab-pane fade show kt-scroll active" id="kt_quick_panel_tab_notifications" role="tabpanel">
						<div class="kt-notification">
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Novo feedback do usuário recebido
									</div>
									<div class="kt-notification__item-time">
										8 horas atrás
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										A reinicialização do sistema foi concluída com sucesso
									</div>
									<div class="kt-notification__item-time">
										12 horas atrás
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Relatório financeiro foi gerado
									</div>
									<div class="kt-notification__item-time">
										25 horas atrás
									</div>
							...
							<a href="#" class="kt-notification__item">
								...
								<div class="kt-notification__item-details">
									<div class="kt-notification__item-title">
										Novo comentário do cliente recebido
									</div>
									<div class="kt-notification__item-time">
										2 dias atrás
									</div>
							...
							<a href="#" class="kt-notification-v2__item">
								...
								<div class="kt-notification-v2__itek-wrapper">
									<div class="kt-notification-v2__item-title">
										5 novo relatório gerado pelo usuário
									</div>
									<div class="kt-notification-v2__item-desc">
										Relatórios baseados em vendas
									</div>
								</div>
							</a>
							<a href="#" class="kt-notification-v2__item">
...
<script src="http://<?php echo APP_HOST; ?>/public/assets/demo/default/base/scripts.bundle.js" type="text/javascript">
</script>

<!--end::Global Theme Bundle -->

<!--begin::Page Vendors(used by this page) -->
<script src="http://<?php echo APP_HOST; ?>/public/assets/vendors/custom/datatables/datatables.bundle.js" type="text/javascript"></script>
<script src="http://<?php echo APP_HOST; ?>/public/assets/vendors/custom/fullcalendar/fullcalendar.bundle.js" type="text/javascript"></script>
<script src="//maps.google.com/maps/api/js?key=AIzaSyBTGnKT7dt597vo9QgeQ7BFhvSRP4eiMSM" type="text/javascript">
</script>
<script src="http://<?php echo APP_HOST; ?>/public/assets/vendors/custom/gmaps/gmaps.js" type="text/javascript">
</script>
...
<script src="http://<?php echo APP_HOST; ?>/public/assets/app/custom/login/login-general.js" type="text/javascript"></script>
<script src="http://<?php echo APP_HOST; ?>/public/assets/app/custom/general/dashboard.js" type="text/javascript">
</script>
