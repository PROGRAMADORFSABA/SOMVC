...
<div class="container">
    ...
    <?php } ?>
    <!--begin::Form-->
    <form class="kt-form kt-form--label-right" action="http://<?php echo APP_HOST; ?>/email/emailPedido" method="post"
        ...
        <div class="kt-portlet__body">
            <div class="kt-portlet__body">
                <div class="form-group">
                    ...
                    <input type="text" name="clienteLicitaca" id="clienteLicitacao" class="form-control" required
                ...
                <div class="form-group row">
                    <div class="col-lg-3">
                        ...
                        <input type="text" class="form-control" placeholder="numero da licitacao" id="numeroPregao"
                            name="numeroPregao" value="<?php echo $viewVar['pedido']->getNumeroLicitacao(); ?>"
                            readonly>
                        <span class="form-text text-muted">numero da licitacao</span>
                    </div>
                    <div class="col-lg-3">
                        <label class="">Numero da AFM:</label>
                        <input type="text" class="form-control" placeholder="numero da AFM" id="numeroAf"
                            name="numeroAf" value="<?php echo $viewVar['pedido']->getNumeroAf(); ?>" readonly>
                        <span class="form-text text-muted">numero da AFM</span>
                    </div>
                    <div class="col-lg-3">
                        <label class="">Valor do pedido:</label>
                        <input type="text" class="form-control" placeholder="valor do pedido" id="valorPedido"
                            name="valorPedido" value="R$<?php echo $viewVar['pedido']->getValorPedido(); ?>" readonly>
                        <span class="form-text text-muted">valor do pedido</span>
                    </div>
                    <div class="col-lg-3">
                        <label class="">Numero do pedido:</label>
                        <input type="text" class="form-control" placeholder="Digite o Numero do pedido"
                            title="este campo se refere ao numero do pedido gerado no ERP" id="numeroPedidoERP"
                            name="numeroPedidoERP" value="<?php echo $viewVar['pedido']->getNumeroPedidoERP(); ?>"
                            readonly>
                ...
                <div class="form-group row">
                    <div class="col-lg-4">
                        ...
                        <input type="text" name="representante" id="representante" class="form-control"
                            value=" <?php echo $viewVar['pedido']->getRepresentante()->getNomeRepresentante(); ?> "
                            readonly>
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="hidden" class="form-control" id="anexo" readonly="readonly" name="anexo"
                            value="<?php echo $viewVar['pedido']->getAnexo(); ?>" readonly>
                ...
                <div class="form-group row">
                    <div class="col-lg-6">
                        ...
                        <textarea class="form-control" rows="4" placeholder="Observacao do Pedido" id="observacao"
                            name="observacao" readonly><?php echo $viewVar['pedido']->getObservacao(); ?></textarea>
                        <span class="form-text text-muted">Observacao do Pedido</span>
                    </div>
                    <div class="col-lg-6">
                        <label class="">Mensagem do usuario:</label>
                        <textarea class="form-control" rows="4" placeholder="Mensagem do usuario" id="mensagem"
                            name="mensagem"></textarea>
                        <span class="form-text text-muted">Mensagem do usuario</span>
                    </div>
                </div>
            </div>
            <div class="form-group row">
                <div class="col-lg-12">
                    ...
                    <input type="text" class="form-control" title="endereco de e-mail"
                        placeholder="email separado por virgula" id="email" name="email" disabled
                        value="vendas2@fabmed.com.br">
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <button type="submit"
                                ...
                                Email</button>
                            <a href="http://<?php echo APP_HOST; ?>/pedido/edicao/<?php echo $viewVar['pedido']->getCodControle(); ?>"
                                class="btn btn-outline-warning btn-elevate btn-pill btn-elevate-air">Alterar</a>
                            <a href="http://<?php echo APP_HOST; ?>/pedido/exclusao/<?php echo $viewVar['pedido']->getCodControle(); ?>"
