...
<div class="container">
    ...
    <?php } ?>
    <!--begin::Form-->
    <form class="kt-form kt-form--label-right" action="http://<?php echo APP_HOST; ?>/pedido/atualizar" method="post"
            ...
            <div class="kt-portlet__body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="text" class="form-control" placeholder="Digite o numero a AFM" id="numeroAf"
                            name="numeroAf" value="<?php echo $viewVar['pedido']->getNumeroAf(); ?>" required>
                        <span class="form-text text-muted">Digite o numero a AFM</span>
                    </div>
                    <div class="col-lg-3">
                        <label class="">Valor do pedido:</label>
                        <input type="text" class="form-control" placeholder="Digite o valor do pedido" id="valorPedido"
                            name="valorPedido" value="<?php echo $viewVar['pedido']->getValorPedido(); ?>" required>
                        <span class="form-text text-muted">Digite o valor do pedido</span>
                    </div>
                    <div class="col-lg-3">
                        <label class="">Numero do pedido:</label>
                        <input type="number" class="form-control" placeholder="Digite o Numero do pedido"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <input type="hidden" class="form-control" id="anexoAlt" readonly="readonly" name="anexoAlt"
                            value="<?php echo $viewVar['pedido']->getAnexo(); ?>">
                ...
                <div class="form-group row">
                    ...
                    <textarea class="form-control" rows="3" placeholder="Digite Observacao do Pedido" id="observacao"
