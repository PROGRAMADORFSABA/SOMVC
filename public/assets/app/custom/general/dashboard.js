...
var KTDashboard = function() {
    ...
    var dailySales = function() {
        var chartContainer = KTUtil.getByID('kt_chart_daily_salesFornecedor');
        var teste = $('#teste').val();
        var top1 = $('#top1').val();
        var top2 = $('#top2').val();
        ...
        var chartData = {
            labels: ['Total fornecedores', "total", "total2", "Label 4", "Label 5", "Label 6", "Label 7", "Label 8", "Label 9", "Label 10", "Label 11", "Label 12", "Label 13", "Label 14", "Label 15", "Label 16"],
            datasets: [{
                //label: 'Dataset 1',
                backgroundColor: KTApp.getStateColor('success'),
                data: [
                    teste, top1, top2, 30, 25, 20, 15, 20, 25, 30, 25, 20, 15, 10, 15, 20
                ]
             },
             {
                //label: ['Dataset 2','teste 01'],
                backgroundColor: '#f3f3fb',
                data: [
                    100, 100, 25, 30, 25, 20, 15, 20, 25, 30, 25, 20, 15, 10, 15, 20
                ]
            }]
        };
...
$(document).ready(function() {
	$.ajax({
		//url : "http://localhost/SOMVC/App/Views/pedido/index.php",
		url : "http://localhost/SOMVC/App/Models/DAO/data.php",
        type : "GET",       
		success : function(lista){
			...
			for (var i = 0; i < len; i++) {
				if (lista[i].nomeStatus == "AUTORIZADO") {
					score.TeamA.push(lista[i].codControle);
				}
				else if (lista[i].nomeStatus == "ANALISE FINANCEIRO") {
					score.TeamB.push(lista[i].codControle);
				}
			}
			console.log(score);//ve no console
			var ctx = $("#line-chartcanvas");//get canvas
			var data = {
				labels : ["Pedido 1", "Pedido 2", "Pedido 3", "Pedido 4", "Pedido 5"],
				datasets : [
					{
						label : "Autorizado",
						data : score.TeamA,
